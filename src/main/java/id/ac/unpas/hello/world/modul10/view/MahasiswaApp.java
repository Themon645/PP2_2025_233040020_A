package id.ac.unpas.hello.world.modul10.view;

import id.ac.unpas.hello.world.modul10.controller.MahasiswaController;
import id.ac.unpas.hello.world.modul10.model.Mahasiswa;
